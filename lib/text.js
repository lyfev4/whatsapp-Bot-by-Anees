...
const menu = (prefix, pushname) => {
	...
	let p = 0
	return ` *ẉḁ.me/ɪͥᴛͭsᷤ ᴍᷟᴇͤ ᴀɴᴇᴇs࿐*
...
const ingfo = `This Bot Programmed With Node.js / JavaScript
GIT CLONE : https://github.com/aneeslub/whatsapp-Bot-by-Anees
Bot !owner is Anees
